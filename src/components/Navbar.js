    ...
    return (
        <header className="bg-slate-800 border-b border-slate-700 px-8 py-4 flex justify-between items-center">
            <h1 className="text-xl font-semibold text-slate-100">
                {isAdmin ? 'Admin Control Panel' : 'User Panel'}
            </h1>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className={`w-10 h-10 ${isAdmin ? 'bg-amber-500' : 'bg-emerald-600'} text-white rounded-full flex items-center justify-center font-bold`}>
